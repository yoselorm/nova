    ...
    <section className="relative py-24 lg:py-32 bg-white overflow-hidden font-nova">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-20 items-center">
          ...
          <div
            ref={imgRef}
            className={`relative transition-all duration-700 ease-out ${imgVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-16'}`}
          >
          ...
          <div
            ref={textRef}
            className={`lg:pl-6 transition-all duration-700 ease-out ${textVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-16'}`}
          >
